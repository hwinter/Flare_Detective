...
;
;-
FUNCTION pg_miller_acoeff,e,eldensity=eldensity;,avckomega=avckomega,utdivbyub=utdivbyub
...
;res=mc2*omegah*0.25*!Dpi*(alfvenspeed)^2*utdivbyub*avckomega*p*g
res=0.25*!Dpi*(alfvenspeed)^2*utdivbyub*avckomega*p*g
