...
;
; $Id: pg_setplotsymbol.pro 5 2007-12-04 21:15:49Z pgrigis $
;
...
PRO pg_setplotsymbol,symbol,size=size,starfactor=starfactor,nofill=nofill

fill=1-keyword_set(nofill)
