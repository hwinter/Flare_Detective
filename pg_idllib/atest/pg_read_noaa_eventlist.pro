...
;
; $Id: pg_read_noaa_eventlist.pro 5 2007-12-04 21:15:49Z pgrigis $
;
; MODIFICATION HISTORY:
;
; 10-SEP-2007 PG written
; 11-SEP-2007 PG corrected bug when event number starts 
;             with a blank rather than a number
;
;-

;.comp pg_read_noaa_eventlist
...
;   print,firstchar
   ...
   IF (byte(firstchar) GE 48B AND byte(firstchar) LE 57B) OR (byte(firstchar) EQ 32B) THEN BEGIN 
