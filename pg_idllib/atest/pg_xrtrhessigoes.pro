...
;
; $Id: pg_xrtrhessigoes.pro 26 2007-12-17 21:02:07Z pgrigis $
;
...
PRO pg_xrtrhessigoes,time_intv,ylog=ylog,xrttickh=xrttickh,xrttickd=xrttickd $
                    ...
                    ,cat=cat,plot_color=plot_color,goes_color=goes_color,color=color $
  ...
  pg_plotgoes,time_intv,ylog=ylog,_extra=_extra,color=plot_color,/sdac
  ...
  pg_plotgoes,time_intv,/overplot,_extra=_extra,color=goes_color,/sdac
