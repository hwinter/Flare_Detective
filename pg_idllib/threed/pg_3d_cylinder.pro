...
PRO pg_3d_cylinder,xinput,xnorm=xnorm,ncirc=ncirc,xx=xx,yy=yy,zz=zz,r1=r1,r2=r2,updatexnorm=updatexnorm
...
FOR i=0,s[1]-1 DO BEGIN 
   ...
   IF NOT keyword_set(updatexnorm) THEN xnorm=oldxnorm
   ...
   IF keyword_set(updatexnorm) THEN xnorm=bas1
