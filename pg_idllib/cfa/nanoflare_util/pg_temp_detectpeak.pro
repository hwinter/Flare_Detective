...
;
; Paolo Grigis
; pgrigis@cfa.hravrd.edu
;
;
; MODIFICATION HISTORY:
;
; 10-DEC-2009 PG documented and clean-up (based on version from about spring 2009)
;-
...
PRO   pg_lc_detectpeak, LightCurve $
                      ...
                      , Tr1EventList=Tr1EventList,Tr2EventList=Tr2EventList,Tr3EventList=Tr3EventList $
                      , Threshold1=InputThreshold1, Threshold2=InputThreshold2,Threshold3=InputThreshold3 $
                      , DoPlot=DoPlot,NormalizationFactor=NormalizationFactor,SmoothingFunction=SmoothingFunction
...
IF keyword_set(doplot) THEN BEGIN 
   ...
   plot,x,SmoothedDerivative,yrange=15*[-Threshold1,Threshold1]
