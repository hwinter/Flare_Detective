...
; CALLING SEQUENCE:
;
; aia_zoomimage_fitpattern,image [,WindowSize=WindowSize $
...
; 18-OCT-2010 modified for diff pattern fitting PG
;
;
;-
...
FUNCTION aia_zoomimage_fitpattern_scaleimage,WidgetData,full=full,zoom=zoom
...
PRO aia_zoomimage_fitpattern_display,WidgetData,EventTop
...
wset,winmap
loadct,0
tv,aia_zoomimage_fitpattern_scaleimage(WidgetData,/full)
...
wset,winmap2
tv,aia_zoomimage_fitpattern_scaleimage(WidgetData,/zoom)
...
PRO aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=ZoomFactor
...
;
FUNCTION aia_zoomimage_fitpattern_outtext,WidgetData
...
;
FUNCTION aia_zoomimage_fitpattern_linefit_text,WidgetData
...
;
PRO aia_zoomimage_fitpattern_event,event
      ...
      print,event.value
       ...
       CASE event.value OF
          ...
          0 : BEGIN ;Draw Images
             ...
             aia_zoomimage_fitpattern_display,WidgetData,event.top

          END 

          1: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=1
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END

          2: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=2
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          3: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=4
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          4: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=6
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          5: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=8
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END

          6: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=12
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END

          7: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=16
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          8: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=0.5
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          9: BEGIN ;sets zoom factors
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=1.0/3
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END
          ...
          11: BEGIN  ;centers zoom window
             ...
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitpattern_setzoom,WidgetData,ZoomFactor=WidgetData.ZoomFactor
             aia_zoomimage_fitpattern_display,WidgetData,event.top
          END 
         ...
         12: BEGIN 
             ;ugly code here
             file='/tmp/tmp1.sav'
             IF file_exist(file) THEN file_delete,file
             save,WidgetData,filename=file
             ;end ugly code
      ...
      CASE event.value OF
         ...
         2: BEGIN ;add point
            ...
            IF WidgetData.NumberOfFittingPoints EQ 0 THEN BEGIN 
               ...
               WidgetData.AllPointsX[0,WidgetData.ThisLine]=*WidgetData.FittingPointX
               WidgetData.AllPointsY[0,WidgetData.ThisLine]=*WidgetData.FittingPointX
           ...
           ELSE BEGIN 
              ...
              WidgetData.AllPointsX[0:n_elements(*WidgetData.FittingPointX)-1,WidgetData.ThisLine]=*WidgetData.FittingPointX
              WidgetData.AllPointsY[0:n_elements(*WidgetData.FittingPointY)-1,WidgetData.ThisLine]=*WidgetData.FittingPointY
       ...
       3: BEGIN ;remove point
            ...
            IF WidgetData.NumberOfFittingPoints LE 1 THEN BEGIN 
               ...
               WidgetData.AllPointsX[*,WidgetData.ThisLine]=0;*WidgetData.FittingPointX
               WidgetData.AllPointsY[*,WidgetData.ThisLine]=0;*WidgetData.FittingPointX
       ...
       7: BEGIN;add line
          ;this codes add a line to the point set
          WidgetData.ThisLine=WidgetData.ThisLine+1
          print,'Line number: '+strtrim(WidgetData.ThisLine,2)
...
widget_control,textwidget,set_value=aia_zoomimage_fitpattern_outtext(WidgetData) 

;updates the Line Fitting information box
textwidget2=widget_info(event.top,find_by_uname='LineFitInfo') 
widget_control,textwidget2,set_value=aia_zoomimage_fitpattern_linefit_text(WidgetData)
...
PRO aia_zoomimage_fitpattern,image,WindowSize=WindowSize $
                 ,ImageSizeX=ImageSizeX,ImageSizeY=ImageSizeY $
                 ,ZoomImageSizeX=ZoomImageSizeX,ZoomImageSizeY=ZoomImageSizeY $
                 ,OutPoints=OutPoints
...
WidgetData={FullImage:image, $
            ...
            DisplayFittedLine:0, $
            AllPointsX:fltarr(64,64), $
            AllPointsY:fltarr(64,64), $
            nlines:0, $
            npoints:0, $
            thisline:0, $
            thispoint:0}
...
;text widget
;
    text=widget_text(menu1,value=aia_zoomimage_fitpattern_outtext(WidgetData) ,ysize=20 $
                    ,uname='frameinfo')
;end text widget

;second set of buttons for fit line functionality
    buttonm2=widget_base(menu1,group_leader=menu1,/row,/frame)
    values=['Fitting On/Off','Reset Points', 'Add Point', 'Remove Point','Show points','Show Line','Print Summary','add line']
...
;
    LineFittingText=widget_text(menu1,value=aia_zoomimage_fitpattern_linefit_text(WidgetData) ,ysize=12 $
                    ,uname='LineFitInfo')
...
aia_zoomimage_fitpattern_display,WidgetData,root

;makes the widget respond to events
;these are handled by aia_zoomimage_fitpattern_event
xmanager,'aia_zoomimage_fitpattern',root;;,/no_block
...
outpoints=[[[widgetdata.allpointsX]],[[widgetdata.allpointsY]]]
