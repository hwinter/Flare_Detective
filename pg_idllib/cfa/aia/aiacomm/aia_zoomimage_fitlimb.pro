...
; CALLING SEQUENCE:
;
; aia_zoomimage_fitlimb,image [,WindowSize=WindowSize $
...
; 12-APR-2010 added fitlimb functionality PG
;-




FUNCTION aia_zoomimage_fitlimb_scaleimage,WidgetData,full=full,zoom=zoom
...
PRO aia_zoomimage_fitlimb_display,WidgetData,EventTop
...
wset,winmap
tv,aia_zoomimage_fitlimb_scaleimage(WidgetData,/full)
...
FOR i=0,WidgetData.NUmberOfFittingPoints-1 DO BEGIN 
      ...
      DisplayX=thisX*ZoomRatioX;-WidgetData.ZoomBoxCenterX)*WidgetData.Zoomfactor+WidgetData.ZoomImageSizeX/2
      DisplayY=thisY*ZoomRatioY;-WidgetData.ZoomBoxCenterY)*WidgetData.Zoomfactor+WidgetData.ZoomImageSizeY/2
...
IF WidgetData.fittingon EQ 1 THEN BEGIN 
   ...
   par=WidgetData.EllipseParameters
   a=par[0]
   b=par[1]
   theta=par[2]
   xc=par[3]
   ...
   zx=(xc+px1*cos(t)+px2*sin(t))*ZoomRatioX
   zy=(yc+py1*cos(t)+py2*sin(t))*ZoomRatioY
   
   plots,zx,zy,col=2,/device
...
wset,winmap2
tv,aia_zoomimage_fitlimb_scaleimage(WidgetData,/zoom)
...
IF WidgetData.displayfittingpoints EQ 1 THEN BEGIN 
   ...
   IF WidgetData.fittingon EQ 1 THEN BEGIN 
      ...
      thisx=(xc+px1*cos(t)+px2*sin(t));*ZoomRatioX
      thisy=(yc+py1*cos(t)+py2*sin(t));*ZoomRatioY
   
      zX=(thisX-WidgetData.ZoomBoxCenterX)*WidgetData.Zoomfactor+WidgetData.ZoomImageSizeX/2
      zY=(thisY-WidgetData.ZoomBoxCenterY)*WidgetData.Zoomfactor+WidgetData.ZoomImageSizeY/2
...
PRO aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=ZoomFactor
...
;
FUNCTION aia_zoomimage_fitlimb_outtext,WidgetData
...
;
FUNCTION aia_zoomimage_fitlimb_linefit_text,WidgetData
...
IF WidgetData.FittingOn EQ 1 THEN BEGIN 
   ...
   IF WidgetData.NumberOfFittingPoints GE 5 THEN BEGIN 
      ...
      xx=*(widgetData.FittingPointX)
      yy=*(widgetData.FittingPointY)

      ;change it to ellipsefitting
      IF WidgetData.DoFitEllipse EQ 1 THEN BEGIN 
         print,'Fit Ellipse now...'
         par=pg_fitellipse(xx,yy)
         widgetData.ellipseParameters=par
         text=[text,string(par)]
         WidgetData.DoFitEllipse=0
      ENDIF 
      ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;       DAngle=(DSlope/(1+Slope^2))*180.0/!Pi
     ; text=[text,string(par)];,'Angle = '+string(Angle,format=FormatString)+' STDEV = '+string(dAngle,format=FormatString)]
...
;
PRO aia_zoomimage_fitlimb_event,event
...
CASE event.ID OF 
      ...
      print,event.value
       ...
       CASE event.value OF
          ...
          0 : BEGIN ;Draw Images
             ...
             aia_zoomimage_fitlimb_display,WidgetData,event.top

          END 

          1: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=1
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END

          2: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=2
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          3: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=4
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          4: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=6
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          5: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=8
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END

          6: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=12
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END

          7: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=16
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          8: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=0.5
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          9: BEGIN ;sets zoom factors
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=1.0/3
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END
          ...
          11: BEGIN  ;centers zoom window
             ...
             widget_control,event.handler,set_uvalue=WidgetData
             aia_zoomimage_fitlimb_setzoom,WidgetData,ZoomFactor=WidgetData.ZoomFactor
             aia_zoomimage_fitlimb_display,WidgetData,event.top
          END 
   ...
   widget_info(event.top,find_by_uname='fitlimb_buttons') : BEGIN

      print,'fitlimb_buttons: '+strtrim(event.value,2)
      ...
      CASE event.value OF
       ...
       6: BEGIN  ;do fitting 
          ...
          WidgetData.DoFitEllipse=1- WidgetData.DoFitEllipse
          widget_control,event.handler,set_uvalue=WidgetData
 
       END 

 
       7: BEGIN ;print summary
...
widget_control,textwidget,set_value=aia_zoomimage_fitlimb_outtext(WidgetData) 

;updates the Line Fitting information box
textwidget2=widget_info(event.top,find_by_uname='LineFitInfo') 
widget_control,textwidget2,set_value=aia_zoomimage_fitlimb_linefit_text(WidgetData)
...
PRO aia_zoomimage_fitlimb,image,WindowSize=WindowSize $
                 ,ImageSizeX=ImageSizeX,ImageSizeY=ImageSizeY $
                 ,ZoomImageSizeX=ZoomImageSizeX,ZoomImageSizeY=ZoomImageSizeY
...
;text widget
;
    text=widget_text(menu1,value=aia_zoomimage_fitlimb_outtext(WidgetData) ,ysize=20 $
                    ,uname='frameinfo')
;end text widget

;second set of buttons for fit line functionality
    buttonm2=widget_base(menu1,group_leader=menu1,/row,/frame)
    values=['Fitting On/Off','Reset Points', 'Add Point', 'Remove Point','Show points','Show Line','do fit','Print Summary']
    uname='fitlimb_buttons'
    bgroup=cw_bgroup(buttonm2,values,/column,uname=uname) 


;Line Fitting text widget
;
    LineFittingText=widget_text(menu1,value=aia_zoomimage_fitlimb_linefit_text(WidgetData) ,ysize=12 $
                    ,uname='LineFitInfo')
...
aia_zoomimage_fitlimb_display,WidgetData,root

;makes the widget respond to events
;these are handeled by aia_zoomimage_fitlimb_event
xmanager,'aia_zoomimage_fitlimb',root,/no_block
