...
PRO xrt_hk_frontmonitor,time=intime,hkfiledir=hkfiledir,hk_outimdir=hk_outimdir
...
filename=hk_outimdir+'tmp11_10days.png'
...
filename=hk_outimdir+'tmp12_10days.png'
tvlct,r,g,b,/get
write_png,filename,tvrd(),r,g,b
