...
;at this point, image is always an image in LINEAR SFU SCALE !!!
		...
		;GOES lightcurves
			!P.MULTI=[2,1,4]
			pg_plotgoes,time_interval,/ylog,int=5,yticklen=1,yminor=1,color=120,yrange=[1e-8,1e-3],xstyle=1,xtitle='',thick=2,/outinfoytitle,title='',charsize=2,xmar=[8,1],ymar=[3,1]
		...
		;RHESSI lightcurves
			...
			utplot,obstimes-obstimes[0],r1,obstimes[0],color=120,yr=[1,MAX([r1,r2,r3]) > 10],/YLOG,tit='RHESSI corrected countrates',xstyle=1,ytit='[cts/s/det]',charsize=2,xmar=[8,1],ymar=[4,0]
			outplot,obstimes-obstimes[0],r2,color=200
			outplot,obstimes-obstimes[0],r3,color=50
			label_plot, 0.03, -1,'6-12 keV',/LINE,color=120	
			label_plot, 0.03, -2,'12-25 keV',/LINE,color=200	
			label_plot, 0.03, -3,'25-100 keV',/LINE,color=50
