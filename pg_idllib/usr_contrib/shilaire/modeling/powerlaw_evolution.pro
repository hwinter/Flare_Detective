...
;
; EXAMPLE:
;	powerlaw_evolution,2e19,4
;	powerlaw_evolution,[2,5,10,20,50,80],4, /ESTAR,LABELS=2
;	powerlaw_evolution,[5,10,20,50,80],4,/ESTAR,modif=1,LABELS=2
;	powerlaw_evolution,[1,2,5,10,20,50],4,/ESTAR,modif=2,LABELS=2
;	powerlaw_evolution,[5,7.5,10,20,50],4,/ESTAR,modif=3,LABELS=2
;

PRO powerlaw_evolution,N,delta, Eco=Eco, ESTAR=ESTAR, modif=modif, yrng=yrng, LABELS=LABELS
	K=2.6e-18	;cm^2 keV^2		
	Ae=1d	
	IF NOT KEYWORD_SET(Eco) THEN Eco=0.1
	IF NOT KEYWORD_SET(modif) THEN modif=0
	IF NOT KEYWORD_SET(yrng) THEN yrng=[1e-8,1]

	E=0.001+DINDGEN(100000)/1000.
	F0=Ae*E^FLOAT(-delta)	;basic power-law
...
PLOT,E,F0,/XLOG,/YLOG,xr=[0.1,100],xtit='Electron energy [keV]',ytit='[e!U-!N keV!U-1!N]',yr=yrng,thick=2.0,xmar=[8,2],ymar=[3,1]
