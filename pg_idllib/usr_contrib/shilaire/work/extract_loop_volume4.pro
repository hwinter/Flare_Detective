; EX:
;	extract_loop_volume4,'2002/02/20 '+['11:06:08','11:07:08'],[907,261]
;
;
;

PRO extract_loop_volume4, time_intv, xyoffset, eband=eband
...
;	imo->plot,/LIMB,grid=90
	...
	FOR i=0,2 DO BEGIN
		...
		label_plot,0.03,-2, ' Eband: '+strn(eband[0])+'-'+strn(eband[1])+'   Det: '+STRJOIN(STRTRIM(det,2)),charsize=lchar,color=lcolor
	...
	PRINT,'psf FWHM ["]: '
	PRINT,strn(pshFWHM_arr)
	PRINT,'Source FWHM ["]: '
	PRINT,[[d1_arr],[d2_arr]]
	PRINT,'Source deconvolved FWHM ["]: '
	PRINT,[[dd1_arr],[dd2_arr]]
	PRINT,'FP distance: '
	PRINT,strn(d12_arr)
	PRINT,'Loop volume '
	PRINT,V_arr
