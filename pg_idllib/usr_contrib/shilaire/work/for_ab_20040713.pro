...
;---------------------------------------------------------------------------------------------------------------------------------------
		...
		;Phoenix-2 spg	
			...
			spectro_plot,image,anytim(time_interval[0],/date)+xaxis,yaxis,xstyle=1,tit='Phoenix-2 - STOKES I - Data min/max: '+strn(datamin,format='(f10.1)')+'/'+strn(datamax,format='(f10.1)')+' SFU',ytit='Frequency [MHz]',xtit=' ',ymar=[1,2],xmar=[8,1]
		;GOES lightcurves
			!P.MULTI=[2,1,4]
			pg_plotgoes,time_interval,/ylog,int=5,yticklen=1,yminor=1,color=120,yrange=[1e-7,1e-2],xstyle=1,xtitle='',thick=2,/outinfoytitle,title='',charsize=2,xmar=[8,1],ymar=[3,1],ytickname=['B1.0','C1.0','M1.0','X1.0','X10','X100']
...
;CORRECTING THE RATES...
	...
	ss=WHERE(obstimes GE anytim('2003/10/28 12:45') AND obstimes LE anytim('2003/10/28 13:10'))
		...
		r3[ss]=r3[ss]*0.3
			...
			utplot,obstimes-obstimes[0],r1,obstimes[0],color=160,yr=[1d1,1d5],/YLOG,tit='RHESSI corrected countrates',xstyle=1,ytit='[cts/s/det]',charsize=2,xmar=[8,1],ymar=[4,0]
