pro mytvellipse, rmax, rmin, xc, yc, pos_ang, color, DATA = data, THICK = thick, $
...
;		 Corrected bug where it assked for a mouse positioning when xc or yc 
;			were < 0, even if /DATA keyword was used. Pascal Saint-Hilaire, ETHZ, 2001/07/19
;-
 ...
 if not keyword_set(DATA) and ((xc LT 0) or (yc LT 0)) then begin
