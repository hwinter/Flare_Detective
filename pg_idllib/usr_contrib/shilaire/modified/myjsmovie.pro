...
; Name        : MYJSMOVIE2
;
; Purpose     : Make a Javascript movie HTML file for a series of PNG/JPEG (/GIF) images
;              
;
; Category    : Imaging
;
...
;
; Syntax      : IDL> myjsmovie,file,images
;
; Inputs      : FILE = filename to which Javascript code will be written
;                      [def=jsmovie_new.html]
;               IMAGES = array of image filenames (e.g. ['frame0.png','frame1.png..])
...
;						-> IDL 5.4 compliant (i.e. takes .png images and no .gif)
;							uncomment lines 257 to 259 in order to add .gif (do this only with IDL 5.3.1 or less)
;
;				EX: myjsmovie,'/global/helene/home/www/staff/shilaire/private/MOVIES/jsmovie___/runme.html', $
;						['fr0000.png',fr0001.png','fr0002.png']
;
; Contact     : DZARRO@SOLAR.STANFORD.EDU
;-

pro myjsmovie,file,images,url=url,delay=delay,increment=increment,$
