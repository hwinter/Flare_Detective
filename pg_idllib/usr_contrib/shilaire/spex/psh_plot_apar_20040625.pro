...
PRO psh_plot_apar_20040625, PS=PS, GOES=GOES, LC=LC, ENERGY=ENERGY, V=V, DENSITY=DENSITY, NUMBER=NUMBER, file=file, CREATEFILE=CREATEFILE, CORRECTED=CORRECTED, L=L,newcorr
