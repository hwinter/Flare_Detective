...
PRO hedc_5x5_te_panel_plot,imo,times,acctim,eband=eband,	$	
	...
	ENDIF
	IF NOT KEYWORD_SET(eband) THEN eband=[[3,12],[12,25],[25,50],[50,100],[100,300]]
	...
	FOR i=0,4 DO BEGIN
		XYOUTS,/DEV,1,dim+addydim-i*dim/5-dim/10-20,strn(eband(0,i))+'-'+strn(eband(1,i)),charsize=charsize
		XYOUTS,/DEV,15,dim+addydim-i*dim/5-dim/10-30,'keV',charsize=charsize
		XYOUTS,/DEV,20+i*dim/5+dim/10,3,anytim(times(i),/ECS,/time),charsize=charsize
	ENDFOR
