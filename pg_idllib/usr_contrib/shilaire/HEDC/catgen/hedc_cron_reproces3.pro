...
default_start_date='2003/07/01'
fil='/global/hercules/data1/hedc/data/HECgeneration/reprocessing_day_3.txt'
...
IF time_intv[0] GE systim2anytim() THEN PRINT,'time_intv bigger than current date!!!!' ELSE BEGIN
	...
	hedc_solar_automatic2,time_intv,GOESmin=[3d-6,1d-5]
