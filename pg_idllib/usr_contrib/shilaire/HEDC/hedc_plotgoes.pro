...
;
;	2003 ~ July: adapted for HEDC usage, PSH.
;
; AUTHOR:
;       Paolo Grigis, Institute for Astronomy, ETH, Zurich
;-

PRO hedc_plotgoes,time,int=int,timegoes=timegoes,datagoes=datagoes,$
      ...
      IF channel NE 3 THEN BEGIN
         ...
         ELSE BEGIN
            ...
            utplot,timegoes,datagoes,timerange=time,$
                   ...
                   yrange=[ymin,ymax],ytickformat='hedc_tickgoes',_extra=e
         ENDELSE   
      ENDIF $
      ELSE BEGIN
