...
;
; V3: 	;If any of the flarelist flares are in within this gev, take the time_intv of the first flarelist item event to the last flarelist item.

;
;.run hedc_test_time_intv3
;-
