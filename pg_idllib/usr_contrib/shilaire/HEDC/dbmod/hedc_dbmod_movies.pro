...
;
; EXAMPLE:
;	hedc_dbmod_movies, 'HXS310281205'
;	hedc_dbmod_movies, 'HXS311021837'
;	hedc_dbmod_movies, 'HXS310240053',/NOCRASH
;	hedc_dbmod_movies, ['2003/10/19','2003/11/06']
;	hedc_dbmod_movies, ['2003/10/21','2003/10/22'],/EIT,/ELLIG
;	hedc_dbmod_movies, ['2003/10/19','2003/11/06'],/EIT,ELLIG=[3,10]
;	hedc_dbmod_movies, ['2003/10/19','2003/11/06'],ELLIG=[3,1000,100],/NOCRASH
;

PRO hedc_dbmod_movies, in, dir=dir, EIT=EIT, ELLIGIBLE=ELLIGIBLE, REPLACE=REPLACE, NOCRASH=NOCRASH

	set_plot,'Z'
	IF NOT KEYWORD_SET(dir) THEN dir='~/TEMP'
...
PRINT,'Flux: '+stdout
		...
		hessi_info={HEDC_CODE: HLElist[i], eband_ss:[1,3]}
		...
		cube=psh_movie(main_info, hessi_info, dir=dir,  mpeg=mpegfil, NOCRASH=NOCRASH)
