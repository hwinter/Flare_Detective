...
;               integration time, not the middle 
;
;-------------------------------------------------------------------------------------------------------
FUNCTION psh_fits2map, fitsfiles, ext1=ext1, BREAKONERROR=BREAKONERROR, imtime_start=imtime_start
	...
	IF Error_Status NE 0 THEN BEGIN
		...
		;;;Error_Status=0
		;CLOSE,/ALL	; in case fits_info.pro is the source of the problem multiple times... but it would be better to use fits_info.pro instead of using this fix...
		RETURN,-1
	ENDIF
