; thick red: corrected spectrum
; thick white: uncorrected spectrum
; dotted white: correction (difference uncorrected-corrected) ?
; thin white: relative correction ?
...
print,'averaged live time is '+strn(average(ltime)*100)+' %'
