function PG_ZBRENT, x1, x2, FUNC_NAME=func_name,    $
...
;       _EXTRA: additional keywords passed to the function
;
; OUTPUTS:
...
;       18-JUL-2007 added keyword _EXTRA for passing optional argument to the
;       function FUNC_NAME
;-
        if N_params() LT 2 then begin
             print,'Syntax - result = ZBRENT( x1, x2, FUNC_NAME = ,'
             print,'                  [ MAX_ITER = , TOLERANCE = , _EXTRA=_EXTRA])'
             return, -1
        endif
