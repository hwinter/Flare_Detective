...
PRO pg_fillnaningaps_test,xin,yin,xout=xout,yout=yout,gaplength=gaplength,twonan=twonan
...
PRO pg_fillnaningaps,xin,yin,xout=xout,yout=yout,gaplength=gaplength,twonans=twonans
