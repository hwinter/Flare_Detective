...
PRO pg_plot_spfitres_special,fitres,intv=intv,position=position,xtickname=newxtickname $
                    ...
                    ,modcontline=modcontline,modthick=modthick,thick=thick,formov=formov
...
;IF keyword_set(formov) THEN modcolor=[modcolor,10,10,10,10,10]
...
IF keyword_set(formov) THEN  $
   pg_plotsp,cntedges,resulttot,color=51,/overplot,/continuous,thick=modthick    
