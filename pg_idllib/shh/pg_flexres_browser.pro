    ...
    widget_info(ev.top,find_by_uname='commands') : BEGIN
        ...
        CASE ev.value OF
            ...
            12 : BEGIN ; 'save new fit results'
                ...
                ENDIF ELSE BEGIN 
                  ; filename='~/work/shh_data/fitresults/corrected/'+'newres_'+'parab_basic' $
                  ;         +'_pileindx_'+smallint2str(03,strlen=2)$
                  ;         +'_intv_'+smallint2str(03,strlen=2)+'.sav'
...
IF allphases[0] EQ -1 THEN ptrspikes=ptr_new()
