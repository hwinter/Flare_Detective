...
FUNCTION vlafitsread2,filename,begtime=begtime,deltatime=deltatime,refx=refx,refy=refy
...
llcx=refx-(ref_pix_x-1)*dx ;x coord of lower left corner of the image
llcy=refy-(ref_pix_y-1)*dy ;y coord of lower left corner of the image

urcx=refx+(npixx-ref_pix_x+1)*dx ;x coord of upper right corner of the image
